...
class ProvincesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create province" do
    assert_difference('Province.count') do
      post provinces_url, params: { province: { cart_id: @province.cart_id, code: @province.code, gst: @province.gst, hst: @province.hst, name: @province.name, pst: @province.pst } }
    end
  ...
  test "should update province" do
    patch province_url(@province), params: { province: { cart_id: @province.cart_id, code: @province.code, gst: @province.gst, hst: @province.hst, name: @province.name, pst: @province.pst } }
